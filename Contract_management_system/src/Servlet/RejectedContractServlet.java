...
/**
 * Servlet implementation class RejectedContractServlet
 */
@WebServlet("/RejectedContractServlet")
public class RejectedContractServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RejectedContractServlet() {
        super();
